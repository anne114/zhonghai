  ...
  <div>
    ...
    <div class="lec-list">
      <mescroll-body
        ...
        :up="upOption"
      >
        <lecture-item :operate_visible="true" :lectures="[12, 3, 4]" />
      </mescroll-body>
    </div>
  </div>
</template>
...
<script>
import search from "@/components/lecture/search.vue";
import lectureItem from "@/components/index/lectureItem.vue";
import MescrollMixin from "@/components/libs/mescroll-uni/mescroll-mixins.js";
export default {
  mixins: [MescrollMixin],
  components: { search, lectureItem },
  data() {
    return {
      downOption: {
